    ...
    switch (name) {
      ...
      case 'passwordConfirm':
        if (value !== password) {
          ...
          setFormValidity({ ...formValidity, passwordConfirm: false });
        } else {
          setFormValidity({ ...formValidity, passwordConfirm: true });
        }
        break;
      default:
        if (!validator.isNotEmpty(value)) {
          message.innerHTML = "Cannot be empty";
          setFormValidity({ ...formValidity, secretAnswer: false });
        } else {
          setFormValidity({ ...formValidity, secretAnswer: true });
        }
        break;
    }
  };
    ...
    <div className={`Register ${props.animate ? 'Register__animated' : ''}`}>
      ...
      <form onSubmit={e => handleSubmit(e)}>
        ...
        <div className="Register__sqa">
          ...
          >
            <option value="" disabled={true}>--Secret Question--</option>
            ...
            <option value="Your mother's middle name">Your mother's middle name</option>
          </select>
          <div className="input-group">
            <input
            ...
            />
            <img src={require('../../assets/icons/question.svg')} alt="Secret Answer"/>
            <p>&nbsp;</p>
          </div>
        </div>
